package xmu.edu.a3plus5.zootv.util;


public class DBUtil {

    public static final String DATABASE_NAME="MySqliteDB.db";    //定义数据库名
    public static final int DATABASE_VERSION=1;                   //定义数据版本

    public static final String User_TABLE_NAME="USERS";           //定义数据库用户表名
    public static final String Category_TABLE_NAME="CATEGORY";   //定义数据库分类表
    ...
    public static final String watchingNum="watchingNum";
