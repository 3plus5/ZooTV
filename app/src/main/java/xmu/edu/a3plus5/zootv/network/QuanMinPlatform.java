...
public class QuanMinPlatform extends BasePlatform{
	...
	{
		String search = "http://www.huomaotv.cn/search?kw=\u6050\u6016&orderby=";
		String poString = "http://www.quanmin.tv/json/page/new-ad/info.json";
		String ad = QuanMinPlatform.sendGet(search, "");
		System.out.println(ad);
        //String s = QuanMinPlatform.sendPost(search, "key=dota2&categoryId=0&page=0&size=90");
